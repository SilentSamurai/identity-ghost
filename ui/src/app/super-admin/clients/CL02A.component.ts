...
import {EditClientAdminComponent} from './dialogs/edit-client-admin.component';
...
export class CL02AComponent implements OnInit {
    ...
    async onEditClient() {
        ...
        const result = await this.modalService.open<Client>(EditClientAdminComponent, {
