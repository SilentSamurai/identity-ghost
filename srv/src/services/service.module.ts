...
@Module(
    {
        ...
        controllers: [],
        providers: [GroupService, AppService, TenantBitsService, ClientService, JwksService, DiscoveryService],
        exports: [GroupService, AppService, TenantBitsService, ClientService, CoreModule, JwksService, DiscoveryService],
    })
